/*menu-driven c program (using switch statement) that takes two input integers 
and performs addition, subtraction, division and multiplication based on the menu option selected by the user.*/
